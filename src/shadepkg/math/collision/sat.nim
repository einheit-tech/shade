...
func projectionFrom*(vertices: seq[Vector], axis: Vector): MinMaxProjectionInterval =
...
proc translateVertices(vertices: seq[Vector], delta: Vector): seq[Vector] =
  for i in 0..<vertices.len:
    result.add(vertices[i] + delta)

func getContactPoint(
  ownerLoc: Vector,
  ownerHull: CollisionShape,
  ownerContactNormal: Vector,
  otherLoc: Vector,
  otherHull: CollisionShape,
  otherContactNormal: Vector
): Vector =
...
func getContactPoint(
  ...
  var
    contactNormalA: Vector
    contactNormalB: Vector
  if isShapeA:
...
func normalizeNormal(isA: bool, axis, projA, projB: Vector): Vector =
...
proc collides*(
  ...
  var
    isShapeA_MTV = true
    intrusion_MTV = Inf
    mtvNormal: Option[Vector]
    isShapeA_Contact = true
    intrusion_Contact = 0f
    contactNormal: Option[Vector]
